HomeController.controller("crtlHome", ["$scope", "$timeout", "administracionServices", "$http", "$sessionStorage",  "$rootScope",
    function (vm = $scope, $timeout, administracionServices, $http, $sessionStorage, vg = $rootScope) {
        ...
        var tknTemp = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjIxMSIsIm5iZiI6MTY1OTc5NzY3OCwiZXhwIjoxNjYwMTU3Njc4LCJpYXQiOjE2NTk3OTc2NzgsImlzcyI6Imh0dHBzOi8vZS1nb2IuYXBwLyIsImF1ZCI6Imh0dHBzOi8vZS1nb2IuYXBwLyJ9.iJwei3hn2Ns_mEby6eVAHbgh12oHHK6DKMNb0l7On6g";
