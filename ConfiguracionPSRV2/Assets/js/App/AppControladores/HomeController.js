HomeController.controller("crtlHome", ["$scope", "$timeout", "administracionServices", "$http", "$sessionStorage",  "$rootScope",
    function (vm = $scope, $timeout, administracionServices, $http, $sessionStorage, vg = $rootScope) {
        ...
        var tknTemp = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjIxMSIsIm5iZiI6MTY1OTM3ODg1NiwiZXhwIjoxNjU5NzM4ODU2LCJpYXQiOjE2NTkzNzg4NTYsImlzcyI6Imh0dHBzOi8vZS1nb2IuYXBwLyIsImF1ZCI6Imh0dHBzOi8vZS1nb2IuYXBwLyJ9.lRt_BUXaU4vk3Z5WnVn2onJyIRe16TUVANSUQmxNC5w";
