HomeController.controller("crtlHome", ["$scope", "$timeout", "administracionServices", "$http", "$sessionStorage",  "$rootScope",
    function (vm = $scope, $timeout, administracionServices, $http, $sessionStorage, vg = $rootScope) {
        ...
        var tknTemp = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjIxMjciLCJuYmYiOjE2NjAxNTgwODIsImV4cCI6MTY2MDUxODA4MiwiaWF0IjoxNjYwMTU4MDgyLCJpc3MiOiJodHRwczovL2UtZ29iLmFwcC8iLCJhdWQiOiJodHRwczovL2UtZ29iLmFwcC8ifQ.LErScoRCi7bpcA_BF-qxZX7jcRkUNyerOh5CKOlWFaA";
